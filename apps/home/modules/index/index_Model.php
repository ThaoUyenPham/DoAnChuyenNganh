...
class index_Model extends Model {
    ...
    public function getChamsocda(){
        $query = "select sp.Hinh,sp.IdSP,Tieude,Gia,KhuyenMai from qldoanchuyennganh.danhmuc dm, 
    ...
    public function getSaleNuoctaytrang(){
        $query = "select sp.Hinh,sp.IdSP,Tieude,Gia,KhuyenMai from qldoanchuyennganh.thongtinctdm ttctdm, 
